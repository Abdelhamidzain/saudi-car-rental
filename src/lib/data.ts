...
// Rich unique paragraphs per city for guide section
export const cityGuides: Record<string, string[]> = {
  riyadh: [
    'تُعتبر العاصمة الرياض المركز الإداري والتجاري للمملكة العربية السعودية، حيث تضم المقرات الحكومية والسفارات الأجنبية ومراكز الأعمال الكبرى. يحتاج الزائر لوسيلة تنقل مرنة نظراً لاتساع المساحة الجغرافية للمدينة وتباعد الأحياء السكنية والتجارية عن بعضها.',
    'تتميز شبكة الطرق بالاتساع والتنظيم الجيد مع وجود عدة طرق دائرية تربط أطراف المدينة ببعضها. ينصح باختيار مركبة مزودة بنظام ملاحة ذكي خاصة للقادمين لأول مرة، فالمسافات بين الوجهات قد تصل لأكثر من ثلاثين كيلومتراً داخل حدود المنطقة الحضرية.',
    'يشهد قطاع الضيافة والترفيه نمواً متسارعاً ضمن رؤية المملكة، مع افتتاح وجهات ترفيهية ضخمة مثل موسم الرياض وبوليفارد سيتي. امتلاك مركبة خاصة يمنحك حرية التنقل بين هذه المعالم بجدول زمني مرن دون الاعتماد على خدمات النقل المشترك.',
  ],
  jeddah: [
    'جدة هي البوابة الغربية للمملكة والعاصمة الاقتصادية، تستقبل ملايين الحجاج والمعتمرين سنوياً عبر مطارها الدولي. الكورنيش الممتد على ساحل البحر الأحمر يوفر تجربة قيادة ممتعة مع إطلالات بحرية خلابة خاصة أثناء غروب الشمس.',
    'تجمع المدينة بين الأصالة والحداثة، فحي البلد التاريخي بمبانيه المرجانية العتيقة يبعد دقائق قليلة عن ناطحات السحاب والمجمعات التجارية العصرية. التنقل بمركبة مستأجرة يتيح لك استكشاف هذا التنوع الثقافي والمعماري بسهولة تامة.',
    'المناخ الساحلي الرطب يجعل اختيار مركبة ذات تكييف قوي أمراً ضرورياً خلال أشهر الصيف. كما أن القرب من مكة المكرمة يجعل استئجار سيارة خياراً مثالياً لمن يرغب بالجمع بين العمرة والسياحة الترفيهية على شواطئ أبحر ورأس السودة.',
  ],
  dammam: [
    'الدمام عاصمة المنطقة الشرقية وأحد أهم المراكز الصناعية والبترولية بالمملكة. تتميز بقربها من مدينتي الخبر والظهران مما يشكّل تكتلاً حضرياً متكاملاً يسهل التنقل فيه بواسطة شبكة طرق حديثة ومباشرة.',
    'واجهة الدمام البحرية ومنتزه الملك عبدالله وجزيرة المرجان تمثل وجهات ترفيهية رئيسية يزورها آلاف العائلات أسبوعياً. قيادة سيارتك الخاصة تمنحك مرونة لزيارة هذه الأماكن بالإضافة لعبور جسر الملك فهد نحو مملكة البحرين.',
    'يتمتع سوق الإيجار بأسعار تنافسية مقارنة بالعاصمة والمنطقة الغربية، مع توافر خيارات واسعة تتراوح بين المركبات الاقتصادية الموفرة للوقود والدفع الرباعي المناسب للرحلات الصحراوية في منطقة الأحساء والربع الخالي.',
  ],
  makkah: [
    'مكة المكرمة أقدس البقاع على وجه الأرض وقبلة المسلمين، تستقبل ملايين الزوار خلال مواسم الحج والعمرة طوال العام. الطبيعة الجبلية للمدينة تتطلب مركبة قوية وموثوقة للتنقل بين الأحياء المرتفعة والمنخفضة.',
    'يزداد الطلب على خدمة استئجار المركبات خلال شهر رمضان وموسم الحج بشكل كبير، لذا ينصح بالحجز المبكر لضمان التوافر والحصول على سعر مناسب. كثير من الشركات توفر خدمة التوصيل من مطار جدة مباشرة إلى مقر إقامتك.',
    'التنقل بين المشاعر المقدسة في منى وعرفات ومزدلفة أثناء موسم الحج يخضع لتنظيمات مرورية خاصة. خارج المواسم تكون حركة السير أكثر انسيابية مع سهولة الوصول للمناطق التجارية والفنادق المحيطة بالحرم الشريف.',
  ],
  madinah: [
    'المدينة المنورة ثاني أقدس مدينة في الإسلام، تتميز بتخطيط عمراني منظم حول المسجد النبوي الشريف مع بنية تحتية حديثة تخدم ملايين الزوار سنوياً. الشوارع الرئيسية واسعة ومضاءة بشكل جيد مما يسهّل القيادة.',
    'من أبرز الوجهات التي يمكنك زيارتها جبل أحد ومسجد قباء ومجمع الملك فهد لطباعة المصحف. استئجار مركبة يمنحك حرية استكشاف المعالم التاريخية والدينية المنتشرة حول المدينة بالسرعة التي تناسبك.',
    'المناخ الصحراوي يتطلب الانتباه لدرجات الحرارة المرتفعة صيفاً بينما يكون الشتاء بارداً نسبياً مع احتمال هطول أمطار. معظم مكاتب الإيجار توفر استلاماً مباشراً من مطار الأمير محمد بن عبدالعزيز الذي يبعد عشر دقائق عن المنطقة المركزية.',
  ],
  khobar: [
    'الخبر واحدة من أجمل مدن الساحل الشرقي، تشتهر بكورنيشها البحري الطويل وقربها المباشر من جسر الملك فهد الرابط بمملكة البحرين. تنعم المدينة بأجواء عائلية هادئة مع توافر مرافق ترفيهية ومطاعم متنوعة.',
    'تقدم شركات الإيجار المحلية أقل الأسعار على مستوى المملكة بفضل المنافسة القوية في السوق المحلي. يمكنك العثور على عروض مغرية للغاية خاصة عند الاستئجار لفترات أسبوعية أو شهرية تشمل تغطية تأمينية شاملة وكيلومترات مفتوحة.',
    'الموقع الجغرافي المتوسط بين الدمام والظهران يجعلها نقطة انطلاق مثالية لاستكشاف المنطقة الشرقية بأكملها. المسافة القصيرة للبحرين عبر الجسر تضيف بُعداً سياحياً فريداً لرحلتك، لكن تأكد من تصريح العبور الدولي للمركبة المستأجرة.',
  ],
}
